...
if (process.env.NODE_ENV == 'development') {
  ...
  axios.defaults.baseURL = 'http://223.84.172.223:9991/';
...
function post(url, params, showLoading,contentType) {
  _showLoading = showLoading;
  axios.defaults.headers[_Authorization] = getToken();
  if(contentType){
    axios.defaults.headers[_ContentType] = "application/json;charset=UTF-8";
